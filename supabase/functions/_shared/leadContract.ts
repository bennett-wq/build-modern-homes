...
// signature used for idempotency. This module has NO imports so it runs under
// both Deno and the browser. It is the CANONICAL server contract: imported by
// supabase/functions/submit-lead/index.ts and verified by index.test.ts.
// The browser copy at src/lib/leadContract.ts must stay identical to this file.
//
