...
export function LotListPanel({
  ...
  return (
    <div className={cn('flex flex-col h-full bg-card border-l border-border', className)} style={style}>
      {/* Header */}
        ...
        <div className="flex flex-wrap gap-1.5">
          {filterOptions.map(option => (
            <Button
              ...
              className={cn(
                'h-7 text-xs px-2.5',
                statusFilter === option.value && 'bg-accent text-accent-foreground hover:bg-accent/90'
              )}
