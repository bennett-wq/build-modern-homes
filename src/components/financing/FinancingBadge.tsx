...
// Displays a subtle badge with tooltip modal explaining MH Advantage / CHOICEHome programs
  ...
  if (variant === 'inline') {
    return (
      <>
        ...
        <FinancingInfoModal open={isOpen} onOpenChange={setIsOpen} />
      </>
    );
  }
...
interface FinancingInfoModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

function FinancingInfoModal({ open, onOpenChange }: FinancingInfoModalProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Understanding your mortgage options for CrossMod® homes
          </DialogDescription>
        </DialogHeader>
