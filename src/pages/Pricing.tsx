...
export default function Pricing() {
  return (
    <Layout>
      <SEO
        title="Transparent Pricing | BaseMod Homes"
        description="See BaseMod's all-in pricing methodology. Real installed prices upfront — no weeks of estimates, no 'it depends.' Know what your home costs before you commit."
        path="/pricing"
      />
      {/* Hero Section */}
